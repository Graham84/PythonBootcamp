...
# Floating point numbers use the format %n1.n2f where the n1 is the total minimum number of digits the string
# should contain (these may be filled with whitespace if the entire number does not have this many digits.
...
# It should be noted that two methods %s and %r actually convert any python object to a string
# using two separate methods: str() and repr(). We will learn more about these functions later on in the course,
# but you should note you can actually pass almost any Python object with these two methods and it will work:
...
print 'String here {var1} then also {var2}'.format(var1='something1', var2='something2')

# Lets see some examples:
print 'This is a string with an {p}'.format(p='insert')
# This is a string with an insert Multiple times:
