...
# Notice how many times the print statements occurred and how the while loop kept going until the True condition was met,
# which occurred once x==10. Its important to note that once this occurred the code stopped.
...
# break and continue statements can appear anywhere inside the loop's body,but we will usually put them further nested
# in conjunction with an if statement to perform an action based on some condition.
