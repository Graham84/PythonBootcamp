...
# Note: Python 2 users, use raw_input() to get player input.
# Python 3 users, use input()

# Step 1: Write a function that can print out a board. Set up your board as a list,
# where each index 1-9 corresponds with a number on a number pad, so you get a
