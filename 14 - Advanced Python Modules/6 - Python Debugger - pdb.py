...
# find errors in your code. A better way of doing this is by
# using Python's built-in debugger module (pdb).
# The pdb module implements an interactive debugging environment
# for Python programs. It includes features to let you pause your
# program, look at the values of variables, and watch program
# execution step-by-step, so you can understand what your program
...
# the power of the pdb module. Note: Keep in mind it would be pretty unusual to use pdb in an iPython Notebook setting.

# Here we will create an error on purpose, trying to add a list
# to an integer
...
# Hmmm, looks like we get an error! Lets implement a set_
# trace() using the pdb module. This will allow us to basically
# pause the code at the point of the trace and check if anything
# is wrong.
...
# Great! Now we could check what the various variables were and
# check for errors. You can use 'q' to quit the debugger.
# For more information on general debugging techniques and more
# methods, check out the official documentation:
