...
# Below is my implementation of a simple game of Blackjack.
# Notice the use of OOP and classes for the cards and hands.

# Let's start by defining some global objects for the cards,
# tuples and a dict.
...
# Now I'll make a card class, it will have some basic ID functions,
...
# Now I'll make a hand class, this class will have functions
# to take into account the Ace situation
...
# Now that the classes are done, time for the cool part,
# creating the actual game!
# First off, making a bet. Need to check if the bet amount
# is within the integer
...
# Next, make a function setting up the game and for dealing out
# the cards.
