...
# Check out the video lectures for more info and the resources for this.
...
# which implement a set of functions. Modules are imported from other
# modules using the import command.
...
# We can look for which functions are implemented in each module by
...
# with the module name, and then import it using the Python file name
...
# special file called __init__.py. This file can be empty, and it
...
# We also must not forget to add the __init__.py file inside the foo
# directory.
...
# the module to our module's name-space.

# The __init__.py file can also decide which modules the package
# exports as the API, while keeping other modules internal,
